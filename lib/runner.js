import { dim, bold, green, yellow, red, cyan, orange, brand, white, renderLogoLine, LOGO_HEIGHT, LOGO_WIDTH } from './ui.js';
...
const STEPS = [
  {
    label: 'Map your API',
    description: ['Point us at your OpenAPI spec, or generate one from your code.'],
  ...
  },
  {
    ...
    description: ["Start your server - we'll confirm the SDK is picking up requests."],
  },
  {
