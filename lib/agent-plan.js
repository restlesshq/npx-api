...
**Nothing you did counts until the user opens that link.** The project stays
unclaimed and invisible to them - logs are flowing, but nobody can see them -
and the link goes stale after a few hours (re-run \`${npx('login')}\` for a fresh
one). Tell the user this in plain words: "You must open this link to finish the
setup - everything I just did is invisible until you do." It is the one step
